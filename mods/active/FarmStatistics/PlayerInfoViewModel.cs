...
namespace FarmStatistics
{
    ...
    public class PlayerInfoViewModel : INotifyPropertyChanged
    {
        ...
        private void InitializeTabs()
        {
            ...
            // 개요 탭
            tabs.Add(new TabData { Name = "overview", Sprite = Tuple.Create(mouseCursors, tabRect), Active = true });
            
            // 인벤토리 탭
            tabs.Add(new TabData { Name = "inventory", Sprite = Tuple.Create(mouseCursors, tabRect), Active = false });
            
            // 스킬 탭
            tabs.Add(new TabData { Name = "skills", Sprite = Tuple.Create(mouseCursors, tabRect), Active = false });
            
            // 설정 탭
            tabs.Add(new TabData { Name = "settings", Sprite = Tuple.Create(mouseCursors, tabRect), Active = false });
