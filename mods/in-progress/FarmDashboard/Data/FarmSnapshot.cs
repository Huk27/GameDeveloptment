...
namespace FarmDashboard.Data
{
    public class FarmSnapshot
    {
        ...
        public Dictionary<string, CropInsight> CropInsights { get; set; } = new();
        public Dictionary<string, AnimalInsight> AnimalInsights { get; set; } = new();
        public ActivitySummarySnapshot ActivitySummary { get; set; } = new();
        ...
        private FarmSnapshot(FarmSnapshot other)
        {
            ...
            CropInsights = other.CropInsights?.ToDictionary(pair => pair.Key, pair => pair.Value.Clone()) ?? new Dictionary<string, CropInsight>();
            AnimalInsights = other.AnimalInsights?.ToDictionary(pair => pair.Key, pair => pair.Value.Clone()) ?? new Dictionary<string, AnimalInsight>();
            ActivitySummary = other.ActivitySummary?.Clone() ?? new ActivitySummarySnapshot();
    ...
    public class HarvestForecastEntry
    {
        ...
        public string Location { get; set; } = string.Empty;
        public int? ExpectedValueEach { get; set; }
        ...
        private HarvestForecastEntry(HarvestForecastEntry other)
        {
            ...
            Location = other.Location;
            ExpectedValueEach = other.ExpectedValueEach;
        }

        public HarvestForecastEntry Clone() => new(this);
    }

    public class AnimalTrackerEntry
    {
        public long Id { get; set; }
        public long Id { get; set; }
        public string Name { get; set; } = string.Empty;
        public string Type { get; set; } = string.Empty;
        public bool PetToday { get; set; }
        public bool ProducedToday { get; set; }
        public int ConsecutiveDaysUntended { get; set; }

        public AnimalTrackerEntry()
        {
        }

        private AnimalTrackerEntry(AnimalTrackerEntry other)
        {
            Id = other.Id;
            Name = other.Name;
            Type = other.Type;
            PetToday = other.PetToday;
            ProducedToday = other.ProducedToday;
            ConsecutiveDaysUntended = other.ConsecutiveDaysUntended;
        }

        public AnimalTrackerEntry Clone() => new(this);
    }
    ...
    public class AnimalInsight
    {
        ...
        public AnimalInsight()
        {
        }

        private AnimalInsight(AnimalInsight other)
        {
            Name = other.Name;
            Type = other.Type;
            Building = other.Building;
            ...
            ConsecutiveDaysUntended = other.ConsecutiveDaysUntended;
            Mood = other.Mood;
            Alerts = new List<string>(other.Alerts);
        }

        public AnimalInsight Clone() => new(this);
    }

    public class ActivitySummarySnapshot
    {
        public List<ActivityBreakdownEntry> Entries { get; set; } = new();
        public List<ActivitySuggestion> Suggestions { get; set; } = new();

        public ActivitySummarySnapshot()
        {
        }

        private ActivitySummarySnapshot(ActivitySummarySnapshot other)
        {
            Entries = CloneList(other.Entries, e => e.Clone());
            Suggestions = CloneList(other.Suggestions, s => s.Clone());
        }

        public ActivitySummarySnapshot Clone() => new(this);
    }
    ...
    public class ActivitySuggestion
    {
        ...
        private ActivitySuggestion(ActivitySuggestion other)
        {
            Title = other.Title;
        ...
        public ActivitySuggestion Clone() => new(this);
    }
    ...
    public class CropInsight
    {
        ...
        private CropInsight(CropInsight other)
        {
            CropName = other.CropName;
            Location = other.Location;
            ReadyCount = other.ReadyCount;
            DaysUntilFirstHarvest = other.DaysUntilFirstHarvest;
            DaysSincePlanted = other.DaysSincePlanted;
            WaterStressTiles = other.WaterStressTiles;
            EstimatedValue = other.EstimatedValue;
            Alerts = new List<string>(other.Alerts);
        }

        public CropInsight Clone() => new(this);
    }
